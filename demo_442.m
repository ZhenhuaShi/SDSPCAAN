...
ks=10:10:100;
nIt=length(ks);
LN={'Baseline','PCA','JPCDA','SDSPCA','SLNP','SPCAN','SDSPCA-LPP','SDSPCAN'};
nAlgs=length(LN);
...
save('demo_442.mat','BCAtrain','BCAtune','BCAtest','times','BestLambda','datasets','nAlgs','LN','lambdas','nRepeats','ks');
